...
class RouteHeader implements SliverPersistentHeaderDelegate {
  final double minExtent;
  final double maxExtent;
  final BikeRoute bikeRoute;

  RouteHeader(this.minExtent, this.maxExtent, this.bikeRoute);
  ...
  double titleOpacity(double shrinkOffset) {
    return max(0, 1.0 - max(0.0, shrinkOffset + 0.2) / maxExtent);
  }
