      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
            ...
            textTheme: TextTheme(
              ...
              headline2: TextStyle(fontSize: 18.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.36), fontFamily: 'OpenSans'),
              bodyText1: TextStyle(fontSize: 14.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.87), fontWeight: FontWeight.bold, fontFamily: 'OpenSans'),
              bodyText2: TextStyle(fontSize: 12.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.65), fontFamily: 'OpenSans'),
              headline5: TextStyle(fontSize: 16.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.87), fontWeight: FontWeight.bold, fontFamily: 'OpenSans'),
              headline4: TextStyle(fontSize: 14.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.54), fontFamily: 'OpenSans'),
              headline3: TextStyle(fontSize: 20.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.87), fontFamily: 'OpenSans'),
              headline6: TextStyle(fontSize: 22.0, color: Color.fromRGBO(37, 14, 19, 1).withOpacity(0.87), fontWeight: FontWeight.bold, fontFamily: 'OpenSans'),
            )),
